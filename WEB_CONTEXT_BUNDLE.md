...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-155-erd-s-problem-155-9ded06ed-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-155"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-155-erd-s-problem-155-9ded06ed-v1",
      "problem_contract_sha256": "50f107076cdd001760a4ae00c0ae35746f7b9f6097e31e5f93362ed4068f179f",
      "problem_id": "problem:um-ep-155-erd-s-problem-155-9ded06ed",
      "route_id": "route:um-ep-155-erd-s-problem-155-9ded06ed-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-155-erd-s-problem-155-9ded06ed-source-fidelity-01",
      "graph_id": "graph:um-ep-155-erd-s-problem-155-9ded06ed-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-155-erd-s-problem-155-9ded06ed-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-155-erd-s-problem-155-9ded06ed-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $F(N)$ be the size of the largest Sidon subset of $\\{1,\\ldots,N\\}$. Is it true that for every $k\\geq 1$ we have $ F(N+k)\\leq F(N)+1 $ for all sufficiently large $N$?"
          },
          "statement_sha256": "3339581eeb2ccc14524c3416f4d3930cf7cee0ad09c8ccebbae9ee1e85c721d7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-155-erd-s-problem-155-9ded06ed-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-155-erd-s-problem-155-9ded06ed-root",
      "route_id": "route:um-ep-155-erd-s-problem-155-9ded06ed-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-155-17abdf893aad",
        "url": "https://www.unsolvedmath.com/problems/EP-155"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
